...
class ResNet_ImageNet_with_gates(nn.Module):
...
class ResNet_ImageNet_without_gates(nn.Module):
...
def ResNet101_ImageNet_with_gates():
    return ResNet_ImageNet_with_gates(Bottleneck_without_gates, [3,4,23,3])

def ResNet101_ImageNet_without_gates():
    return ResNet_ImageNet_without_gates(Bottleneck_without_gates, [3,4,23,3])
